...
function create() {
    ...
    // Load the high score from localStorage (or set it to 0 if not found)
...
function hitBomb(player, bomb) {
    ...
    // Check if the score is a new high score and update localStorage if it is
    if (score > highScore) {
        highScore = score;
    ...
    retryButton.on('pointerdown', () => {
        this.scene.restart();
        score = 0;  // Reset the score on retry
